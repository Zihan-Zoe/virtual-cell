"""
Replogle K562 Essential Perturb-seq Dataset
===============================================================
...
# 1. LOAD DATA
# =============================================================================
H5AD_PATH = "./data/replogle_k562.h5ad"
...
NOTE: Replogle K562 dataset contains ONLY single-gene perturbations (no dual-gene combos)
...
# ================================================================================
# USING PRE-COMPUTED SPLITS
# ================================================================================
# load splits with plain pandas:

import pandas as pd

# Load split masks (only 'simulation' split for Replogle K562)
split_type = 'simulation'
masks = pd.read_csv(f'./data/splits_replogle_k562/split_{split_type}.csv')
